...
pub(crate) use authority::{
    AuthorityRoot, DestinationRepositoryRoot, MutationIntent, ObjectClass, PathError, ReadOnly,
    RelativePath, RunRecordRoot, SourceSnapshotRoot, open_mutation_root, sync_directory, sync_file,
};
