...
fn product_package_contains_runtime_only_files() {
    ...
    let allowed = [
        ...
        "src/lifecycle/release_publish.rs",
        "src/lifecycle/release_tag.rs",
        "src/lifecycle/release_trigger.rs",
        "src/lifecycle/release_gates.rs",
