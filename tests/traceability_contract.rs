...
fn implementation_status_cannot_claim_future_work() {
    ...
    let source = matrix().replacen(
        "\"implementation_bead\":\"omni-constitutional-convergence-2r9.54\",\"implementation_status\":\"specified\"",
        "\"implementation_bead\":\"omni-constitutional-convergence-2r9.54\",\"implementation_status\":\"implemented\"",
        1,
    );
